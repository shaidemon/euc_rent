package ru.daemon75.euc_rent.config;
...
@Configuration
@ComponentScan("ru.daemon75.euc_rent")
@EnableWebMvc
@EnableJpaRepositories("ru.daemon75.euc_rent.repositories")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.daemon75.euc_rent.models");
